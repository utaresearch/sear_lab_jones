...
function initialize_dopf_admm!(data::Dict{String, <:Any}, model_type::Type; alpha::Real=1000, beta::Real=0, gamma::Real=0, tol::Float64=1e-4, max_iteration::Int64=1000)
...
function run_dopf_admm(data::Dict{String, <:Any}, model_type::Type, optimizer; alpha::Real=1000, tol::Float64=1e-4, max_iteration::Int64=1000, verbose = true)

    run_dopf(data, model_type, build_dopf_admm, update_admm!, optimizer, alpha=alpha, initialize_method=initialize_dopf_admm!, tol = tol, max_iteration=max_iteration, verbose=verbose)

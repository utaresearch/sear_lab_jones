...
function initialize_dopf!(data::Dict{String, <:Any}, model_type;  tol::Float64=1e-4, max_iteration::Int64=1000, parameters...)
...
function run_dopf(data::Dict{String, <:Any}, model_type, build_method::Function, update_method::Function, optimizer; alpha::Real=1000, beta::Real=0, gamma::Real=0, initialize_method::Function=initialize_dopf!, tol::Float64=1e-4, max_iteration::Int64=1000, verbose = true)
    ...
    for i in areas_id
        initialize_method(data_area[i], model_type, tol=tol, max_iteration=max_iteration, alpha= alpha, beta=beta, gamma=gamma)
    end

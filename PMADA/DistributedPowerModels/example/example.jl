...
data_area = PMADA.run_dopf_admm(data, model_type, optimizer, alpha=1000, tol=1e-4, max_iteration=1000, verbose = true)

data_area = PMADA.run_dopf_app(data, model_type, optimizer, alpha=1000, tol=1e-4, max_iteration=1000, verbose = true)

data_area = PMADA.run_dopf_atc(data, model_type, optimizer, alpha=1.05, tol=1e-4, max_iteration=1000, verbose = true)
